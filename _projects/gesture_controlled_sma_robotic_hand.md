...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project1_hand.png" title="project1 hand image" class="img-fluid rounded z-depth-0" %}
    </div>
</div>
<div class="caption">
    3D printed Robotic Hand with SMA actuators.
</div>

<div class="row justify-content-sm-center">
  <div class="col-sm-8 mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/project1_handgesture.png" title="Hand Gesture" class="img-fluid rounded z-depth-0" %}
  </div>
</div>
<div class="caption">
  Left: Hand Gesture Glove. Right: SMA-actuated Robot Hand.
</div>

<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project1_tool.png" title="example image" class="img-fluid rounded z-depth-0" %}
    </div>
</div>
<div class="caption">
